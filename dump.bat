...
arm-none-eabi-objdump target/thumbv4t-none-eabi/debug/examples/ex3 --section-headers --disassemble --demangle --architecture=armv4t --no-show-raw-insn -Mreg-names-std >target/ex3.txt
